    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :skuImage="skuImage" />
          <!-- 小图列表 -->
          <ImageList :skuImage="skuImage" />
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(saleAttr, index) in spu" :key="saleAttr.id">
                ...
                <dd
                  ...
                  :key="attrValue.id"
                  @click="choose(attrValue,saleAttr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" @change="changeSkuNum" v-model="skuNum"/>
...
export default {
  ...
  computed: {
    ...mapGetters(["categoryView", "skuInfo", "spu"]),
    skuImage() {
